...
3. **Transparent Reason Codes**: Recommendations explicitly expose *why* a candidate was recommended (e.g., `["EXACT_SKILL_MATCH: DaVinci Resolve", "BUDGET_ALIGNED", "TOP_RATED_EDITOR"]`).
